...
@router.post("/bad-cases", response_model=BadCaseRead, dependencies=[Depends(require_permission("quality:manage"))])
...
@router.patch("/bad-cases/{case_id}", response_model=BadCaseRead, dependencies=[Depends(require_permission("quality:manage"))])
...
@router.post("/evaluations/run", response_model=EvaluationResultRead, dependencies=[Depends(require_permission("quality:manage"))])
